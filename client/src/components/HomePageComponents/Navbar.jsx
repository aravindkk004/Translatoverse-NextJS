  ...
  return (
    <>
      ...
      >
        <div>
          <Link href="/">
            <img src="./images/logo.png" height={60} width={200} />
          </Link>
        </div>
        <div>
          <ul className="hidden lg:flex items-center gap-6">
            <Link href="#home" className="hover:text-primary hover:font-bold transition-all cursor-pointer text-lg">
              Home
            </Link>
            <Link href="#howitworks" className="hover:text-primary hover:font-bold transition-all cursor-pointer text-lg">
              How it works
            </Link>
            <Link href="#testimonials" className="hover:text-primary hover:font-bold transition-all cursor-pointer text-lg">
              Review
            </Link>
            <Link href="#contact" className="hover:text-primary hover:font-bold transition-all cursor-pointer text-lg">
              Contact
            </Link>
            <Link href="#faq" className="hover:text-primary hover:font-bold transition-all cursor-pointer text-lg">
              FAQ
            </Link>
          </ul>
        </div>
        ...
        {isToggle && (
          <div className="toggle-bar h-screen w-full md:w-1/2 bg-white shadow-xl absolute top-0 left-0 px-5 py-20 z-2">
            <ul className="text-lg">
              <li className="mb-[10px] px-4 py-2 hover:text-primary" onClick={()=>setIstoggle(false)}>
              ...
              <li className="px-4 py-2 hover:text-primary" onClick={()=>setIstoggle(false)}>
